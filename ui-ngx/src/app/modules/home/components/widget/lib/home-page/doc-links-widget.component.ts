      ...
      links: [
        {
          ...
          link: 'https://aqualogics.app/docs/getting-started-guides/helloworld/'
        },
        {
          icon: 'title',
          name: 'Tenant profiles',
          link: 'https://aqualogics.app/docs/user-guide/tenant-profiles/'
        },
        {
          icon: 'insert_chart',
          name: 'API',
          link: 'https://aqualogics.app/docs/api/'
        },
        {
          icon: 'now_widgets',
          name: 'Widgets Library',
          link: 'https://aqualogics.app/docs/user-guide/ui/widget-library/'
        }
      ]
    }],
    [Authority.TENANT_ADMIN, {
      links: [
        ...
        },
        {
          ...
          name: 'Rule engine',
          link: 'https://aqualogics.app/docs/user-guide/rule-engine-2-0/re-getting-started/'
        },
        {
          icon: 'insert_chart',
          name: 'API',
        ...
        },
        {
          ...
          link: 'https://aqualogics.app/docs/user-guide/device-profiles/'
        }
      ]
    }],
      ...
      links: [
        {
          icon: 'rocket',
          name: 'Getting started',
          link: 'https://aqualogics.app/docs/getting-started-guides/customer_helloworld/'
        }
      ]
    }]
  ]
